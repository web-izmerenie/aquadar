...
<section class="description">
	...
	<div class="desc-item">
		...
		<div class="text">
			<h3>1. Все напитки с содержанием сока «Южный день» — низкокалорийные</h3>
			<p>Негазированная сладкий напиток «Южный день»
не содержит сахар (содержание углеводов даже
меньше чем 0,1 г на 100 г жидкости).</p></div>
		<img src="/upload/limonad/desc3.jpg">
	</div>
	<div class="desc-item">
		<img src="/upload/limonad/desc2.jpg">
		<div class="text">
			<h3>2. Специально подобранные вкусы напитка и отсутствие мякоти</h3>
			<p>Все вкусы сокосодержащего напитка «Южный день»
